var TestCrowdsale = artifacts.require('../contracts/TestCrowdsale.sol');
...
async function liveDeploy(deployer, accounts) {
  ...
  return deployer.deploy(TestCrowdsale, startTime, endTime, rate, address).then(async() => {
    // Wait until its depoyed
    const contract = await TestCrowdsale.deployed();
